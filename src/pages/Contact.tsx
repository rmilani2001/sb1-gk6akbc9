...
const Contact = () => {
  ...
  if (status === 'success') {
    return (
      <div className="min-h-screen pt-20">
        <Helmet>
          <title>Message Sent | MixMasterMilani</title>
        </Helmet>
  ...
  return (
    <div className="min-h-screen pt-20">
      <Helmet>
        <title>Contact | MixMasterMilani</title>
        <meta name="description" content="Get in touch with MixMasterMilani for your next event in Napa Valley." />
      </Helmet>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
