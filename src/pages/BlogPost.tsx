...
const BlogPostPage = () => {
  ...
  if (!post) {
    return (
      <div className="min-h-screen pt-20">
        <Helmet>
          <title>Post Not Found | MixMasterMilani</title>
        </Helmet>
  ...
  return (
    <div className="min-h-screen pt-20">
      <Helmet>
        <title>{post.title} | MixMasterMilani</title>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <article className={`bg-white/5 rounded-2xl overflow-hidden backdrop-blur-sm ${
