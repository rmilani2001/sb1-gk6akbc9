...
const About = () => {
  return (
    <div className="min-h-screen pt-20">
      <Helmet>
        <title>About MixMasterMilani | Napa Valley DJ & Music Curator</title>
        <meta name="description" content="Learn about MixMasterMilani's unique approach to curating sophisticated soundscapes for Napa Valley's premier events and venues." />
      </Helmet>
